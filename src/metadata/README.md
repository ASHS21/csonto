 ...
 * [csonto.yml](csonto.yml)
     * Determines how your purl.obolibrary.org/obo/csonto/ redirects will be handled
     ...
     * Paste in the contents of [csonto.yml](csonto.yml)
 ...
 * [csonto.md](csonto.md)
     ...
     * Paste in the contents of [csonto.md](csonto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
